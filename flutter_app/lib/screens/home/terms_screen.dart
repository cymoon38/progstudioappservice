...
제1조 (목적)
이 약관은 프록 스튜디오(이하 "회사"라 함)이 제공하는 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
앱테크와 커뮤니티 서비스를 결합한 형식으로 사용자는 그림관련 게시물을 올리거나 미션등에 참가하여 코인을 얻고 이 코인으로 기프티콘을 구매 할 수 있습니다.
회사는 상당한 이유가 있는 경우에 운영상, 기술상의 필요에 따라 제공하고 있는 서비스를 변경할 수 있습니다.
회사는 이용자에게 서비스를 제공함에 있어 관련 법령, 약관, 운영정책 및 공지사항 등에서 정한 바에 따라 무료로 서비스를 제공합니다.
...
회사와 회원 간 발생한 분쟁에 관한 소송은 서울중앙지방법원의 관할로 합니다.
...
회사가 규정하는 어뷰징(미션 중복 참여, 캠페인 중복 참여 등으로 부당하게 이득을 얻는 경우), 선정적인 게시물을 게시하는 행위, 도배하는 행위, 개인정보 유출을 하는 행위, 기타 처벌 대상이라고 판단되는 행위는 규칙에 따라 처벌될 수 있습니다.

부칙
이 약관은 2026-03-08부터 시행합니다.
""";
